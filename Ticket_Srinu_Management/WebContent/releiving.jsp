...
<h4 style="color:#fff;" align="center"><b>Releiving Letter</b></h3>
		...
		<form action="#" method="post">	
			...
			<div class="w3l-date">
					...
					<label class="head">Start Date<span class="w3l-star"> * </span></label>
						<div class="styled-input">
							<input class="date" id="datepicker1" name="Text" type="text" value="MM/DD/YYYY" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MM/DD/YYYY';}" required="">
						</div><br>
					</div>
					<div class="w3l-date">
			...
			<div class="w3l-date">
					<label class="head">Date of Designation<span class="w3l-star"> * </span></label>
						<div class="styled-input">
