...
<h4 style="color:#fff;" align="center"><b>Leave</b></h3>
...
<div class="w3l-from">
		<form action="ApplyLeave.jsp" method="post">	
			<div class="w3l-date">
					<label class="head">Start Date <span class="w3l-star"> * </span></label>
						<div class="styled-input">
							<input class="date" id="datepicker" name="startdate" type="text" value="MM/DD/YYYY" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MM/DD/YYYY';}" required="">
						</div><br>
					</div>
			<div class="w3l-date">
					<label class="head">End Date<span class="w3l-star"> * </span></label>
						<div class="styled-input">
							<input class="date" id="datepicker1" name="enddate" type="text" value="MM/DD/YYYY" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MM/DD/YYYY';}" required="">
						</div><br>
					</div>
			<div  class="w3l-options1">
				<label class="head">Leave Type<span class="w3l-star"> * </span></label>	
					<select class="category1" name="leavetype" required="">
						<option></option>
			...
			<div class="w3l-user">
				<label class="head">Reason<span class="w3l-star"> * </span></label>
				<input type="text" name="reason" placeholder=""  "required="">
			</div>
				...
				<div class="btn center-block"  >
					...
					<input type="submit" value="Submit" onclick="form.action='SecondServlet';"/>
