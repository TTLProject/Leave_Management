...
<h4 style="color:#fff;" align="center"><b>Employee Details</b></h3>
...
<div class="w3l-main">
<div class="w3l-from">
		<form action="empdetails1.jsp" method="post">	
			<div class="w3l-date">
					<label class="head">Joining Date <span class="w3l-star"> * </span></label>
			...
			<div  class="w3l-options1">
				<label class="head">Package<span class="w3l-star"> * </span></label>	
					<select class="category1"  name="package1" required="">
					<!-- <tr><td>Select Domain Name:</td><td><select name="course"> -->
						<option></option>
			...
			<div class="w3l-user">
				<label class="head">UAN Number<span class="w3l-star"> * </span></label>
				<input type="text" name="uannumber" placeholder=""  "required="">
			</div>
			<div class="w3l-user">
				<label class="head">Account Number<span class="w3l-star"> * </span></label>
				<input type="text" name="accountnumber" placeholder=""  "required="">
			</div>
